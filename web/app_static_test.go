...
func TestAppScriptPostsToExperienceStreamAndRendersPresentationEvents(t *testing.T) {
	...
	for _, want := range []string{
		...
		"knowledge-evidence-snippet",
		"Knowledge: review gated",
...
func TestAdminShellLoadsPersonaAdminScript(t *testing.T) {
	...
	for _, want := range []string{
		...
		`"/admin/knowledge/repairs"`,
		`"/admin/knowledge/repairs/retest"`,
		`"/admin/knowledge/repairs/recurrences"`,
		`"/admin/knowledge/repairs/recurrences/confirm"`,
		`"/admin/knowledge/repairs/recurrences/dismiss"`,
		`"/admin/knowledge/quality-trends"`,
		`"/admin/knowledge/quality-review-checkpoints"`,
		"loadKnowledgeQualityTrends",
		"loadQualityReviewHistory",
		"saveQualityReviewCheckpoint",
		"renderKnowledgeQualityTrends",
		"quality-trends-from",
		"quality-trends-to",
		"quality-trends-space",
		"quality-trends-refresh",
		"quality-review-form",
		"quality-review-outcome",
		"quality-review-rationale",
		"quality-review-save",
		...
		"knowledge-repair-body",
		"knowledge-repair-status",
		"knowledge-repair-reason",
		"knowledge-repair-weak-only",
		"knowledge-repair-unresolved-only",
		"knowledge-repair-linked-evidence",
		"knowledge-repair-refresh",
		"knowledge-quality-trends",
		"quality-trends-from",
		"quality-trends-to",
		"quality-trends-space",
		"quality-trends-refresh",
		"loadKnowledgeRepairs",
		"renderKnowledgeRepairItem",
		"retestKnowledgeRepair",
		"recurrence_state",
		"Confirm recurrence",
		"Dismiss recurrence",
		...
		"review_gated_documents",
		"no_review_active_documents",
		"duplicate_content",
...
func TestAdminShellIncludesKnowledgeLifecycleControls(t *testing.T) {
	...
	for _, want := range []string{
		...
		`id="knowledge-repair-inbox"`,
		`id="knowledge-repair-body"`,
		`id="knowledge-repair-status"`,
		`id="knowledge-repair-reason"`,
		`id="knowledge-repair-weak-only"`,
		`id="knowledge-repair-unresolved-only"`,
		`id="knowledge-repair-linked-evidence"`,
		`id="knowledge-repair-refresh"`,
		`id="knowledge-quality-trends"`,
		`id="quality-trends-from"`,
		`id="quality-trends-to"`,
		`id="quality-trends-space"`,
		`id="quality-trends-refresh"`,
		`id="quality-review-context"`,
		`id="quality-review-form"`,
		`id="quality-review-outcome"`,
		`id="quality-review-rationale"`,
		`id="quality-review-save"`,
		`id="quality-review-comparison"`,
		`id="quality-review-history"`,
		`promotion_state`,
		...
		`id="knowledge-filter-review-status"`,
